<div class="et_manage_input">
                                    <select name="country" id="country" required>
                                        ...
                                        <option value="Korea, Dem People&#039;S Republic">Korea, Dem People&#039;S
                                            Republic</option>
                                        <option value="Korea, Republic Of">Korea, Republic Of</option>
                                        <option value="Kuwait">Kuwait</option>
                                        <option value="Kyrgyzstan">Kyrgyzstan</option>
                                        <option value="Lao People&#039;S Dem Republic">Lao People&#039;S Dem Republic
                                        </option>
                                        ...
                                        <option value="South Georgia , S Sandwich Is.">South Georgia , S Sandwich Is.
                                        </option>
