...
<div class="container register">
      ...
      ?>
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control form-control-lg" id="firstname" name="email" required placeholder="Enter Email">
                    </div>
                </div>
                 <div class="form-group">
                    <input type="submit" class="btnRegister"  value="Reset" name="reset" />
                    </form>
                                     </div>
                                </div>
                            </div>
