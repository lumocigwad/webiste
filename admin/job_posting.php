      ...
      ?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="ibox">
                            <div class="ibox-head">
                                <div class="ibox-title">Careers</div>
                                
                            </div>
                            <div class="ibox-body">
                                <div class="container">
                               <form class="form-horizontal" method="POST" action="insert_career.php" enctype="multipart/form-data">
...
<!--                 <div class="form-group">
     ...
     -->         <div class="form-group">
                  <label for="content" class="col-sm-3 control-label"><b>Description</b></label>
                  <div class="col-sm-12">
